...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand nav-brand" href="#" data-aos="fade-down">DAS</a>
            <span class="text-muted ms-3" data-aos="fade-down" data-aos-delay="100">WE VALUE YOUR HEALTH</span>
    ...
    <header class="bg-success text-white text-center py-5" data-aos="fade-up">
    ...
    <section class="container my-5">
        <h2 class="text-center text-success mb-4" data-aos="fade-up">Top Hospitals</h2>
        <div class="row g-4">
    ...
    <section class="features">
        <div class="container">
            <h2 class="text-center mb-4" data-aos="fade-up">Why Choose DAS?</h2>
    ...
    <section class="container my-5">
        <h2 class="text-center text-success mb-4" data-aos="fade-up">Testimonials</h2>
        <div class="row">
