...
<body>
    ...
    <div class="container">
        <div class="card">
            <div class="doctor-info">
                <img id="doctor-img" src="https://via.placeholder.com/150" alt="Doctor Image"
            ...
            <div class="form-section">
                ...
                <div class="hospital-box" id="hospital">
                    <?php
                    foreach ($selected_hospital_name as $index => $hospital_name):
                        ?>
            ...
            <form id="booking-form">
                ...
                <div class="form-section">
                    ...
                    <textarea class="form-control" name="symptoms" id="symptoms" rows="3" required
    ...
    document.addEventListener('DOMContentLoaded', function() {
            ...
            (async () => {
                ...
                if (isValidDate(book_date)) {
                    const response = await fetch(
                            `fetch_dates.php?hospital_id=${hospitalId}&doctor_id=${doctorId}`)
                        .catch(error => {
                    ...
                    if (jsonData) {
                        ...
                        for (let i = 0; i < 60; i++) {
                            ...
                            if (jsonData.includes(dateStr) || jsonData.some(d => d.toLowerCase() ===
                                    weekday.toLowerCase())) {
                ...
                `;
                            ...
                            dateElement.addEventListener('click', function() {
                                ...
                                dateBox.querySelectorAll('.option-box').forEach(b => b
        ...
        function fetchTimes(hospitalId, date, d) {
            ...
            timeBox.innerHTML = '';
            fetch(
                    `fetch_times.php?hospital_id=${hospitalId}&date=${date}&doctor_id=${doctorId}&day=${d.toLocaleString('default', { weekday: 'short' })}`)
                ...
                .then(data => {
                    data.forEach(time => {
                        ...
                        timeElement.addEventListener('click', function() {
                            timeBox.querySelectorAll('.option-box').forEach(b => b.classList
                                .remove('selected'));
                            this.classList.add('selected');
                        });
        ...
        document.getElementById("booking-form").addEventListener("submit", function(event) {
            ...
            const selectedTime = selectedTimeElement ? (selectedTimeElement.dataset.time ||
                selectedTimeElement.innerText.trim()) : null;
            ...
            fetch("booking_appointment.php", {
                ...
                .then(data => {
                    Notiflix.Loading
                .remove(); // Always remove the loading indicator after the response
        ...
        async function fetchBookedDates(hospitalId) {
            try {
                const response = await fetch(
                    `fetch_booked_dates.php?hospital_id=${hospitalId}&doctor_id=${doctorId}`);
                const data = await response.text();
